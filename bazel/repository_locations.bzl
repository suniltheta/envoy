...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_aws_aws_xray_daemon = dict(
        project_name = "AWS X-Ray Daemon",
        project_desc = "Go daemon for relaying tracing data to the AWS X-Ray API",
        project_url = "https://github.com/aws/aws-xray-daemon",
        version = "3.2.0",
        sha256 = "ea74139ba52ff7395d75c2a18dac312d7aad9b9ed097293e7073342f843a9637",
        strip_prefix = "aws-xray-daemon-{version}",
        urls = ["https://github.com/aws/aws-xray-daemon/archive/{version}.tar.gz"],
        use_category = ["observability_ext"],
        extensions = ["envoy.tracers.xray"],
