...
public:
  ...
  MetadataCredentialsProviderBase(Api::Api& api, ServerFactoryContextOptRef context, Upstream::ClusterManager& cm,
...
public:
  InstanceProfileCredentialsProvider(Api::Api& api, ServerFactoryContextOptRef context, Upstream::ClusterManager& cm,
                                     const CurlMetadataFetcher& fetch_metadata_using_curl,
                                     CreateMetadataFetcherCb create_metadata_fetcher_cb,
...
public:
  ...
  TaskRoleCredentialsProvider(Api::Api& api, ServerFactoryContextOptRef context, Upstream::ClusterManager& cm,
                              const CurlMetadataFetcher& fetch_metadata_using_curl,
                              CreateMetadataFetcherCb create_metadata_fetcher_cb,
...
class WebIdentityCredentialsProvider : public MetadataCredentialsProviderBase,
                                       public MetadataFetcher::MetadataReceiver {
public:
  WebIdentityCredentialsProvider(Api::Api& api, ServerFactoryContextOptRef context, Upstream::ClusterManager& cm,
                                 const CurlMetadataFetcher& fetch_metadata_using_curl,
                                 CreateMetadataFetcherCb create_metadata_fetcher_cb,
...
public:
  ...
  virtual CredentialsProviderSharedPtr createWebIdentityCredentialsProvider(
      Api::Api& api, ServerFactoryContextOptRef context, Upstream::ClusterManager& cm,
...
public:
  DefaultCredentialsProviderChain(
      Api::Api& api, ServerFactoryContextOptRef context, Upstream::ClusterManager& cm, absl::string_view region,
      const MetadataCredentialsProviderBase::CurlMetadataFetcher& fetch_metadata_using_curl)
      : DefaultCredentialsProviderChain(api, context, cm, region, fetch_metadata_using_curl, *this) {}
...
private:
  ...
  CredentialsProviderSharedPtr createTaskRoleCredentialsProvider(
    ...
    return std::make_shared<TaskRoleCredentialsProvider>(api, context, cm, fetch_metadata_using_curl,
  ...
  CredentialsProviderSharedPtr createWebIdentityCredentialsProvider(
    ...
    return std::make_shared<WebIdentityCredentialsProvider>(
        api, context, cm, fetch_metadata_using_curl, create_metadata_fetcher_cb, token_file_path,
